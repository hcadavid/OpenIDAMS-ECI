...
/**
 * Exception associated to the datatable instantiation
 * @author ECITeam
 * @version 0.0.6
 */
@SuppressWarnings("serial")
public class DataTableInstantiationException extends Exception {

    /**
     * Creates an exception with the given message
     * @param message Message of the exception
     */
	public DataTableInstantiationException(String message) {
        super(message);
    }
     ...
     */
    public DataTableInstantiationException(String message, Throwable cause) {
        super(message, cause);
    }
}
