...
/**
 * Exception associated to the instantation of procedures
 * @author ECITeam
 * @version 0.0.6
 */
@SuppressWarnings("serial")
public class ProcedureInstantiationException extends Exception {
     ...
     */
	public ProcedureInstantiationException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message Message of the exception
     */
    public ProcedureInstantiationException(String message) {
        super(message);
    }
}
